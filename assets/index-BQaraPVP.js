import{aV as w,aL as v,aM as y,aN as x,aU as $,aR as g,aW as R,bb as T,aS as m,aO as C}from"./index-B4FB8RH4.js";import{n as P,r as h,c as b}from"./index-BzwPHkqV.js";const s=x({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),_={state:s,subscribe(t){return y(s,()=>t(s))},subscribeKey(t,e){return v(s,t,e)},showTooltip({message:t,triggerRect:e,variant:o}){s.open=!0,s.message=t,s.triggerRect=e,s.variant=o},hide(){s.open=!1,s.message="",s.triggerRect={width:0,height:0,top:0,left:0}}},n=w(_),O=$`
  :host {
    width: 100%;
    display: block;
  }
