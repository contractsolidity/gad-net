import{aU as Y,aR as g,bb as W,aG as K,aS as c,b2 as _,b8 as j,bk as G,aO as E,aP as D,aQ as H,aF as N,ay as m,bl as V,aY as k,aZ as A,a_ as h,aX as L,bm as X,bn as v,aA as z,az as O,aB as q,aW as Q}from"./index-MrIsvSTx.js";import{r as d,c as w,n as l,o as Z}from"./index-D8A9B33I.js";import"./index-DVDFyDyr.js";import{e as J,n as ee}from"./ref-C8vtdnrl.js";import"./index-CygwJ6C2.js";import{H as I}from"./HelpersUtil-CsXFo9KX.js";import"./index-5Qr2DoX9.js";import"./index-DBsONMHJ.js";import"./index-XR2RW88P.js";import"./index-B8idSdHP.js";import"./index-D_qh9OJ1.js";import{N as te}from"./NavigationUtil-DmfK5sOV.js";import"./ConstantsUtil-COJBkkkj.js";const ie=Y`
  div {
    width: 100%;
  }
...
`;var y=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(o=(n<3?a(o):n>3?a(t,i,o):a(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};const ne={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},ae={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let u=class extends g{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return c`
    ...
    `}};B=se([w("w3m-upgrade-wallet-view")],B);var C=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(o=(n<3?a(o):n>3?a(t,i,o):a(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};let $=class extends g{constructor(){super(...arguments),this.loading=!1,this.switched=!1,this.text="",this.network=m.state.activeCaipNetwork}render(){return c`
    ...
    `}isV6(){return(V.get("dapp_smart_account_version")||"v6")==="v6"}toggleSmartAccountVersion(){V.set("dapp_smart_account_version",this.isV6()?"v7":"v6"),typeof window<"u"&&window?.location?.reload()}togglePreferredAccountTypeTemplate(){const t=this.network?.chainNamespace,i=m.checkIfSmartAccountEnabled(),r=_.getConnectorId(t);return!_.getAuthConnector()||r!==k.CONNECTOR_ID.AUTH||!i?null:(this.switched||(this.text=A(t)===h.ACCOUNT_TYPES.SMART_ACCOUNT?"Switch to your EOA":"Switch to your Smart Account"),c`
      <wui-list-item
        icon="swapHorizontal"
        ?rounded=${!0}
        ?chevron=${!0}
    ...
    `)}async changePreferredAccountType(){const t=this.network?.chainNamespace,i=m.checkIfSmartAccountEnabled(),r=A(t)===h.ACCOUNT_TYPES.SMART_ACCOUNT||!i?h.ACCOUNT_TYPES.EOA:h.ACCOUNT_TYPES.SMART_ACCOUNT;_.getAuthConnector()&&(this.loading=!0,await L.setPreferredAccountType(r,t),this.text=r===h.ACCOUNT_TYPES.SMART_ACCOUNT?"Switch to your EOA":"Switch to your Smart Account",this.switched=!0,X.resetSend(),this.loading=!1,this.requestUpdate())}};C([d()],$.prototype,"loading",void 0);C([d()],$.prototype,"switched",void 0);C([d()],$.prototype,"text",void 0);C([d()],$.prototype,"network",void 0);$=C([w("w3m-smart-account-settings-view")],$);const ce=E`
  :host {
    width: 100%;
  }
...
`;var pe=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(o=(n<3?a(o):n>3?a(t,i,o):a(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};let U=class extends g{render(){return c`
    ...
    </wui-flex>`}redirectToAccount(){Q.replace("Account")}};U.styles=ue;U=pe([w("w3m-register-account-name-success-view")],U);export{R as W3mApproveTransactionView,U as W3mRegisterAccountNameSuccess,p as W3mRegisterAccountNameView,$ as W3mSmartAccountSettingsView,B as W3mUpgradeWalletView};
